...
function Enemytable(props) {
  ...
  const [cardWithForce, setCardWithForce] = useState([m1, m2, m3, m4, m5, m6]);
    ...
    if (mindTrickAttacker && mindTrickDefender) {
      switch (mindTrickAttacker.fightCard.name) {
        case "quigon":
          ...
          client.send(
            JSON.stringify({
              ...
              card: {
                ...
                defence:
                  chanceCube === 1
                    ? mindTrickAttacker.fightCard.defence + 700
                    : mindTrickAttacker.fightCard.defence - 700,
              },
              position: mindTrickDefender.position,
            })
          );
          const newAttacker = {
            ...mindTrickAttacker,
          ...
          setTimeout(function () {
            mindTrickFight(mindTrickDefender, newAttacker);
          }, 2000);
          break;
        ...
        case "ahsoka":
          ...
          if (mindTrickDefender.fightCard.side === "dark") {
            ...
            setTimeout(function () {
              mindTrickFight(newDefender, mindTrickAttacker);
            }, 2000);
          }
          break;
              ...
              case "dark":
                ...
                client.send(
                  JSON.stringify({
                    ...
                    position: mindTrickAttacker.position,
                  })
                );
                setTimeout(function () {
                  mindTrickFight(mindTrickDefender, newAttacker);
    ...
    if (!mindTrickDefender.fightCard.immune) {
      ...
      if (defence < attacker.fightCard.attack) {
        if (defender.fightCard.isDef) {
          ...
          const diference =
            attacker.fightCard.attack - defender.fightCard.defence;
          client.send(
            JSON.stringify({
              type: "talk_to_attacker",
              adress: props.enemyId,
            ...
            if (defender.fightCard.side === "light") {
              client.send(
                JSON.stringify({
                  ...
                  card: {
                    ...attacker.fightCard,
                    attacker: attacker.fightCard.attack + 400,
                  },
                  position: attacker.position,
                })
              );
      ...
      if (locked.active) {
        client.send(
          JSON.stringify({
            ...
            card: {
              ...m,
              locked: { active: true, round: enemyTurn.round + 3 },
              isDef: !m.isDef,
            },
        ...
        client.send(
          JSON.stringify({
            type: "talk_to_attacker",
            adress: enemyId,
            card: { ...m, attack: m.attack - 300, defence: m.defence - 300 },
            position: position.toString(),
          })
        );
  ...
  return (
    <div className="enemy-card-container">
      ...
      <div className="enemy-card-table">
        ...
        >
          <img
            ...
            style={Object.assign(
              ...
              willAttack === "1" ||
                willAttack2 === "1" ||
                mindTrickAttacker.position === "1" ||
                mindTrickDefender.position === "1"
                ? {
            ...
            onMouseOver={(e) => {
              setImg({ img: e.target.src, description: e.target.alt });
            }}
            onMouseOut={() => {
          ...
          {m1 && m1.maulCurse.active ? (
            <img id="darthmaul" src={darthmaul} className="sword" />
          ) : (
            ""
          )}
          ...
          {m1.side == "dark" && mindTrick.attackerActive ? (
            <img src={pulse} className="sword" />
          ) : (
            ""
          )}
          {m1 &&
          mindTrick.defenderActive &&
          mindTrick.attackerPosition !== 1 ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
          {m1.side == "light" && !m1.forceChoke && bleed.active ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
        ...
        >
          <img
            ...
            style={Object.assign(
              ...
              willAttack === "2" ||
                willAttack2 === "2" ||
                mindTrickAttacker.position === "2" ||
                mindTrickDefender.position === "2"
                ? {
                    animation: "shake 0.5s",
                    animationIterationCount: "infinite",
                  }
          ...
          {m2.side == "dark" && mindTrick.attackerActive ? (
            <img src={pulse} className="sword" />
          ) : (
            ""
          )}
          {m2 &&
          mindTrick.defenderActive &&
          mindTrick.attackerPosition !== 2 ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
          {m2.side == "light" && !m2.forceChoke && bleed.active ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
        ...
        >
          <img
            ...
            style={Object.assign(
              ...
              willAttack === "3" ||
                willAttack2 === "3" ||
                mindTrickAttacker.position === "3" ||
                mindTrickDefender.position === "3"
                ? {
                    animation: "shake 0.5s",
                    animationIterationCount: "infinite",
                  }
          ...
          {m3.side == "dark" && mindTrick.attackerActive ? (
            <img src={pulse} className="sword" />
          ) : (
            ""
          )}
          {m3 &&
          mindTrick.defenderActive &&
          mindTrick.attackerPosition !== 3 ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
          {m3.side == "light" && !m3.forceChoke && bleed.active ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
        ...
        >
          <img
            ...
            style={Object.assign(
              ...
              willAttack === "4" ||
                willAttack2 === "4" ||
                mindTrickAttacker.position === "4" ||
                mindTrickDefender.position === "4"
                ? {
                    animation: "shake 0.5s",
                    animationIterationCount: "infinite",
                  }
          ...
          {m4.side == "dark" && mindTrick.attackerActive ? (
            <img src={pulse} className="sword" />
          ) : (
            ""
          )}
          {m4 &&
          mindTrick.defenderActive &&
          mindTrick.attackerPosition !== 4 ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
          {m4.side == "light" && !m4.forceChoke && bleed.active ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
        ...
        >
          <img
            ...
            style={Object.assign(
              ...
              willAttack === "5" ||
                willAttack2 === "5" ||
                mindTrickAttacker.position === "5" ||
                mindTrickDefender.position === "5"
                ? {
                    animation: "shake 0.5s",
                    animationIterationCount: "infinite",
                  }
          ...
          {m5.side == "dark" && mindTrick.attackerActive ? (
            <img src={pulse} className="sword" />
          ) : (
            ""
          )}
          {m5 &&
          mindTrick.defenderActive &&
          mindTrick.attackerPosition !== 5 ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
          {m5.side == "light" && !m5.forceChoke && bleed.active ? (
            <img src={sword} className="sword" />
          ) : (
            ""
          )}
        ...
        <div name="m6" className={`card ${m6 ? "full" : "empty"}`}>
          <img
