...
function Room({ client }) {
  ...
  function joinRoom(e) {
    ...
    if (data) {
      if (
        existRoom(createJoinNumber) &&
        data[data.findIndex((obj) => obj.room === createJoinNumber)].players
          .guest.id == ""
      ) {
        ...
        const updatedArray = copyData.map((p) =>
          p.room === createJoinNumber
            ? {
                ...
                players: {
                  ...p.players,
                  guest: { username: createJoinName, id: uniqueId },
                },
              }
            : p
        );
        ...
        client.send(
          JSON.stringify({ type: "data_update", state: updatedArray })
        );
        ...
        >
          ...
          <div className="prologue">
            <div className="text">
              ...
              <p>
                For all the crews of all the movies, even those made in CGI.
              </p>
              ...
              <p>
                For all those who love Star Wars, and for all those will love
                it....
              </p>
            </div>
          </div>
